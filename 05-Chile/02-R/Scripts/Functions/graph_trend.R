graph_trend <- function(
  ...
  if (yearly == FALSE) {
    ...
    plot <- ggplot() +
      ...
      annotate("segment", color = "#FF0100", x = 14, xend = 15, y = legend_upper + legend_upper * 0.03, yend = legend_upper + legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#18466E", x = 14, xend = 15, y = legend_upper - legend_upper * 0.1, yend = legend_upper - legend_upper * 0.1, size = 1) +
      geom_point(aes(x = 14.55, y = legend_upper + legend_upper * 0.03), shape = 16, size = 3, color = "#FF0100") +
      geom_point(aes(x = 14.55, y = legend_upper - legend_upper * 0.1), shape = 18, size = 4, color = "#18466E") +
      geom_text( family = "Roboto", fontface = "bold", x = 16.2, y = legend_upper + legend_upper * 0.03, aes(label = label_treatment_legend)) +
      geom_text( family = "Roboto", fontface = "bold", x = 16, y = legend_upper - legend_upper * 0.1, aes(label = label_control_legend))
    ...
    plot <- ggplot() +
      ...
      theme(
        ...
        plot.subtitle = element_text(size = rel(1), hjust = 0, vjust = 5),
        legend.position="none") + 
      annotate("segment", color = "#FF0100", x = 2022.5, xend = 2023, y = legend_upper + legend_upper * 0.03, yend = legend_upper + legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#18466E", x = 2022.5, xend = 2023, y = legend_upper - legend_upper * 0.03, yend = legend_upper - legend_upper * 0.03, size = 1) +
      geom_point(aes(x = 2022.75, y = legend_upper + legend_upper * 0.03), shape = 16, size = 3, color = "#FF0100") +
      geom_point(aes(x = 2022.75, y = legend_upper - legend_upper * 0.03), shape = 18, size = 4, color = "#18466E") +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper + legend_upper * 0.03, aes(label = label_treatment_legend)) +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper - legend_upper * 0.03, aes(label = label_control_legend))
  ...
  if (yearly == FALSE) {
    ...
    plot <- ggplot() +
      ...
      theme(
        ...
        legend.position="none") + 
      annotate("segment", color = "#FF0100", x = 14, xend = 15, y = legend_upper + legend_upper * 0.03, yend = legend_upper + legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#18466E", x = 14, xend = 15, y = legend_upper - legend_upper * 0.03, yend = legend_upper - legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#63A15D", x = 14, xend = 15, y = legend_upper - legend_upper * 0.1, yend = legend_upper - legend_upper * 0.1, size = 1) +
      geom_point(aes(x = 14.55, y = legend_upper + legend_upper * 0.03), shape = 16, size = 3, color = "#FF0100") +
      geom_point(aes(x = 14.55, y = legend_upper - legend_upper * 0.03), shape = 18, size = 4, color = "#18466E") +
      geom_point(aes(x = 14.55, y = legend_upper - legend_upper * 0.1), shape = 18, size = 4, color = "#63A15D") +
      geom_text( family = "Roboto", fontface = "bold", x = 16.2, y = legend_upper + legend_upper * 0.03, aes(label = "ONLY COVID")) +
      geom_text( family = "Roboto", fontface = "bold", x = 16, y = legend_upper - legend_upper * 0.03, aes(label = "ONLY NON COVID")) + 
      geom_text( family = "Roboto", fontface = "bold", x = 16, y = legend_upper - legend_upper * 0.1, aes(label = "MIXED"))
    ...
    plot <- ggplot() +
      ...
      annotate("segment", color = "#FF0100", x = 2022.5, xend = 2023, y = legend_upper + legend_upper * 0.03, yend = legend_upper + legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#18466E", x = 2022.5, xend = 2023, y = legend_upper - legend_upper * 0.03, yend = legend_upper - legend_upper * 0.03, size = 1) +
      annotate("segment", linetype = 2, color = "#63A15D", x = 2022.5, xend = 2023, y = legend_upper - legend_upper * 0.1, yend = legend_upper - legend_upper * 0.1, size = 1) +
      geom_point(aes(x = 2022.75, y = legend_upper + legend_upper * 0.03), shape = 16, size = 3, color = "#FF0100") +
      geom_point(aes(x = 2022.75, y = legend_upper - legend_upper * 0.03), shape = 18, size = 4, color = "#18466E") +
      geom_point(aes(x = 2022.75, y = legend_upper - legend_upper * 0.1), shape = 18, size = 4, color = "#63A15D") +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper + legend_upper * 0.03, aes(label = "ONLY COVID")) +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper - legend_upper * 0.03, aes(label = "ONLY NON COVID")) +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper - legend_upper * 0.1, aes(label = "MIXED"))
...
graph_trend_three_medical <- function(
  ...
  if (yearly == FALSE) {
    ...
    plot <- ggplot() +
      ...
      geom_point(aes(x = 14.55, y = legend_upper - legend_upper * 0.03), shape = 18, size = 4, color = "#18466E") +
      geom_point(aes(x = 14.55, y = legend_upper - legend_upper * 0.1), shape = 18, size = 4, color = "#63A15D") +
      geom_text( family = "Roboto", fontface = "bold", x = 16.2, y = legend_upper + legend_upper * 0.03, aes(label = "ONLY MEDICAL")) +
      geom_text( family = "Roboto", fontface = "bold", x = 16, y = legend_upper - legend_upper * 0.03, aes(label = "ONLY NON MEDICAL")) +
    geom_text( family = "Roboto", fontface = "bold", x = 16, y = legend_upper - legend_upper * 0.1, aes(label = "MIXED"))
    ...
    plot <- ggplot() +
      ...
      geom_line(data = data %>% filter(tender_medical == "ONLY MEDICAL"), aes(x = as.numeric(DT_Y), y = !!variable), size = 0.7, color = "#FF0100") +
      geom_line(data = data %>% filter(tender_medical == "ONLY NON MEDICAL"), aes(x = as.numeric(DT_Y), y = !!variable), size = 0.7, color = "#18466E", linetype = 2) +
      geom_line(data = data %>% filter(tender_medical == "MIXED"), aes(x = as.numeric(DT_Y), y = !!variable), size = 0.7, color = "#63A15D", linetype = 2) +
      labs(title    = title,
           subtitle = subtitle,
           caption  = caption,
           x = NULL,
      ...
      geom_point(aes(x = 2022.75, y = legend_upper - legend_upper * 0.03), shape = 18, size = 4, color = "#18466E") +
      geom_point(aes(x = 2022.75, y = legend_upper - legend_upper * 0.1), shape = 18, size = 4, color = "#63A15D") +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper + legend_upper * 0.03, aes(label = "ONLY MEDICAL")) +
      geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper - legend_upper * 0.03, aes(label = "ONLY NON MEDICAL")) +
    geom_text( family = "Roboto", fontface = "bold", x = 2023.7, y = legend_upper - legend_upper * 0.1, aes(label = "MIXED"))
