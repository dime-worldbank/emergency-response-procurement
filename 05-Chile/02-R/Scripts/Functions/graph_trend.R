graph_trend <- function(
  ...
  if (yearly == FALSE) {
    ...
    plot <- ggplot() +
      ...
      ggplot2::annotate("segment", linetype = 2, color = "#A89F93", x = 13, xend = 14, y = (legend_upper + legend_upper * 0.03 + legend_upper - legend_upper * 0.5)/2, yend = (legend_upper + legend_upper * 0.03 + legend_upper - legend_upper * 0.5)/2, size = 1) +
      ...
      geom_point(aes(x = 13.55, y = (legend_upper + legend_upper * 0.03 + legend_upper - legend_upper * 0.5)/2), shape = 18, size = 4, color = "#A89F93") +
      ...
      geom_text( family = "Roboto", fontface = "bold", x = 15, y = (legend_upper + legend_upper * 0.03 + legend_upper - legend_upper * 0.5)/2, aes(label = label_control_2_legend))
