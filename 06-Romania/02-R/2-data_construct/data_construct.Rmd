...
awards.final.22 <- readRDS("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania-Justicia/Dashboard/Data/Final/awards-constructed.rds")
...
complaints.final.22 <- readRDS("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania-Justicia/Dashboard/Data/Final/complaints-constructed.rds")
...
initiation.final.22 <- readRDS("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania-Justicia/Dashboard/Data/Final/initiation-constructed.rds")
...
table(awards.final.22$award_year)

vars_awards <- ls(awards.final)
vars_awards22 <- ls(awards.final.22)

## Initiation data
table(initiation.final$initiation_year)
table(initiation.final.22$initiation_year)

vars_initiation <- ls(initiation.final)
vars_initiation22 <- ls(initiation.final.22)

# Initiation data 22 is at the initiation-lot level, we have to collapse to initiation level 
initiation.final.22.init <- initiation.final.22 %>% 
...
dates.contracts <- awards.final.complete %>% 
  select(initiation_notice_id, lot_number, winner_cui_id, award_notice_date, contract_date) %>% 
  rename(bidder_cui = winner_cui_id)
...
ggplot(bids.monthly, aes(x=date, y=N_bidders)) +
  geom_line() + ylab("") + xlab("Year") + ylim(0, 200000)+ labs(title = "Total number of bidders", caption = "Number of bidders is defined as the number of firms who bid within a contract and lot in a year.") + theme(plot.caption = element_text(hjust = 0))
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_bidders.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_bidders_per_tender.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_bidders_nocontract.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/share_number_bidders_nocontract.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_bidders_type.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_bidders_per_tender_type.png")
...
ggplot(bids.monthly2, aes(x=date, y=share_bidders_not_awarded, col = type_wb)) +
  geom_line() + ylab("") + xlab("Year") + labs(title = "Share of bidders with no previous award", caption = "Number of bidders is defined as the number of firms who bid within a contract and lot in a year \n that did not have a previous contract.") + theme(plot.caption = element_text(hjust = 0))
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/share_number_bidders_per_tender_type.png")
...
awards.final.complete <- awards.final.complete %>% 
  ...
  arrange(winner_cui_id,contract_date, lot_number) %>% 
...
awards.final.complete <- awards.final.complete %>% 
  group_by(winner_cui_id, cpv_group) %>% 
  arrange(winner_cui_id,contract_date, lot_number) %>% 
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/new_winners_and_bidders.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/new_winners_type.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/new_bidders_type.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/share_contracts_new_winners_type.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/share_contracts_new_winners_sector_type.png")
# type of new winner instead of color 
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/Number_winners_perCPV.png")
write_xlsx(number.winners.table,"C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Tables/winners_sector.xlsx")

## number of winners per sector (3 digits of CPV codes)
number.bidders <- bids.final.complete %>% 
  filter(cpv_group!="NA") %>% 
  group_by(cpv_group, cpv_group_name) %>% 
  summarise(number_bidders = n()) %>% 
...
firms.total <- awards.final.complete %>% 
  filter(cpv_group!="NA") %>%
  group_by(winner_cui_id, cpv_group, cpv_group_name, contract_year) %>% 
...
# Plot
ggplot(firm.sector.total.top5, aes(x=total_share, color=contract_year)) +
geom_histogram(position="identity", fill = NA) + labs(title = "Average top 5 firms' market share per sector", caption = "The total value of firms' contracts per sector is calculated by obtaining the total value of the firm's contract \n  at the sector level (3 digits of CPV code), divided by the total value from all contracts at the sector level") + theme(plot.caption = element_text(hjust = 0))
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/Firms_share_yearly.png")

## ver grafico en lines (density)
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/total_value_tenders.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/average_value_tenders_type.png")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_tenders_type.png")
...
ggplot(initiation.final.cpv.month2, aes(x = date, y = number_tenders, col = type_wb)) +
  geom_line()+ ylab("") + xlab("Year") + labs(title = "Number of contracts, simplified procedure only", caption = "Number of conctracts is the sum of the contracts per sector.") + theme(plot.caption = element_text(hjust = 0))
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/number_tenders_type_simplified_only.png")
...
write_xlsx(appeals,"C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/datasets/2-clean/appeals.xlsx")

write_xlsx(procedures,"C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/datasets/2-clean/procedures.xlsx")
...
appeals.en <- read_excel("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/datasets/2-clean/appeals_en.xlsx")

procedures.en <- read_excel("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/datasets/2-clean/procedures_en.xlsx")
...
write_xlsx(complaints.final.export,"C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/datasets/2-clean/complaints_translated.xlsx")
...
ggsave("C:/Users/vgamarra/Dropbox/RA-UChicago/DIME-WB/Romania/analysis/Figures/average_tenders_contract.png")
...
awards.month1 <- awards.final.complete %>% 
  filter(contract_year_number>1) %>% 
  group_by(cpv_group, month_yr_init) %>% 
  summarise(contract_value_cpv_month_tot = sum(value_est_ron)) 

awards.month2 <- awards.final.complete %>% 
  filter(contract_year_number>1) %>% 
  group_by(cpv_group, month_yr_init, ca_central) %>% 
  summarise(contract_value_cpv_month = sum(value_est_ron)) 

other <- left_join(awards.month1, awards.month2, by = c('cpv_group','month_yr_init'))
...
awards.month1 <- awards.final.complete %>% 
  filter(contract_year_number>1) %>% 
  group_by(cpv_group, month_yr_init, type_wb) %>% 
  summarise(contract_value_cpv_month_tot = sum(value_est_ron)) 

awards.month2 <- awards.final.complete %>% 
  filter(contract_year_number>1) %>% 
  group_by(cpv_group, month_yr_init, ca_central, type_wb) %>% 
  summarise(contract_value_cpv_month = sum(value_est_ron)) 

other <- left_join(awards.month1, awards.month2, by = c('cpv_group','month_yr_init', 'type_wb'))
