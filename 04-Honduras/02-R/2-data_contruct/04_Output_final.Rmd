...
fwrite(tender_contract_grouped, file = paste0(cleaned, "/Number_of_tenders.csv"))
...
fwrite(contract, file = paste0(cleaned, "/Number_of_contracts.csv"))
...
fwrite(contract_value, file = paste0(cleaned, "/Contracts_value.csv"))
...
fwrite(method_share, file = paste0(cleaned, "/Procurement_method.csv"))
...
# explore the number of products sold by the firm before, during and after COVID (before assigning to groups)
...
fwrite(firm_item, file = paste0(cleaned, "/firm_item.csv"))
...
fwrite(firm_item_did, file = paste0(cleaned, "/Firm_item_did.csv"))
...
fwrite(firm_sector_total_top3, file = paste0(cleaned, "/Market_concentration.csv"))
...
fwrite(tender_contract, file = paste0(cleaned, "/Duration.csv"))
...
fwrite(contract_supplier, file = paste0(cleaned, "/New_winner.csv"))
...
write.csv(tender_item, file = "C:/Users/wb554125/WBG/DIME3 Files - FY23 MDTF project/Covid_datawork/03-Honduras/Data/3_Cleaned/tender_item.csv")
write.csv(supplier_item,file = "C:/Users/wb554125/WBG/DIME3 Files - FY23 MDTF project/Covid_datawork/03-Honduras/Data/3_Cleaned/supplier_item.csv")
