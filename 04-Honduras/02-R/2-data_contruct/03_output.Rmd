...
knitr::opts_chunk$set(warning = TRUE, message = FALSE, fig.width=10, fig.height=8) 
```
...
method_share <- tender_contract_value_grouped %>%
  mutate(method = ifelse(CAT_TENDER_METHOD_DETAIL == "Compra Menor" |
                           ...
                           CAT_TENDER_METHOD_DETAIL == "Contrataci�n directa"|
                           CAT_TENDER_METHOD_DETAIL == "Licitaci�n privada"|
