...
### also generated an excel sheet of all the contracts 
...
### To construct COVID dummy, we search for COVID related key words in the item description, contract description, tender description columns, and IDs.
...
```{r 4.1 construct new winners, echo=FALSE}

## 4.0 NEW WINNERS - construct with contract signature ---------------------------
...
```{r 4.2 construct new winners, echo=FALSE}
      ...
      # summary statistics 
          new_winner_month_group <- contract_supplier_grouped%>%
      ...
      # visualization 
          ggplot(new_winner_month_group, aes(x = semester, y = share_new_winner, group = Group))+
            ...
            labs(x = "Tender Publication Date (aggregate by semester)", y = "Share of New Winners (%)", title = "Share of New Winners 2016-2022",
                 caption = "Note: data retrieved from ONCAE on Mar 2023")+
...
```{r 5.1 time, echo=FALSE, warning=FALSE} 
...
```{r 5.2 submission time, echo=FALSE, warning=FALSE}
      ...
      submission_time <- tender_contract%>%
        ...
        labs(x = "Tender Publication Date (aggregate by semester)", y = "Submission Time (days)", 
             ...
             subtitle = "Average Number of Days from Tender Inquiry Start to Tender Inquiry End from Jan 2015 to Dec 2022",
...
```{r 5.3 processing time, echo=FALSE, warning=FALSE}
      ...
      ggplot(processing_time, aes(x = semester, y = processing_time_avg, group = Group))+
        ...
        labs(x = "Tender Publication Date (aggregate by semester)", y = "Processing Time (days)", 
             ...
             subtitle = " Average Number of Days from Tender Inquiry Start to Contract Signature Date from Jan 2015 to Dec 2022",
...
```{r 5.4 decision time, echo=FALSE, warning=FALSE}
      ...
      ggplot(decision_time, aes(x = semester, y = decision_time_avg, group = Group))+
        ...
        labs(x = "Tender Publication Date (aggregate by semester)", y = "Decision Time (days)", 
             title = "Decision Time",
             subtitle = "Number of Days from Tender Inquiry End to Contract Signature Date from Jan 2015 to Dec 2022",
             caption = "Note: data retrieved from ONCAE in Mar 2023.")+
...
### Market Concentration: the market share of the top 3 suppliers in each sector per quarter (ranking firms by total market value of their items)
### x: the market share of top 3 suppliers 
### y: contract signature date 

```{r 6.1 market concentration share, echo=FALSE}
...
```{r 6.1 market concentration share visual, echo=FALSE}
      ...
      ggplot(firm_sector_total_top3, aes(x = semester, y = top3_share, group = Group))+
        ...
        labs(x = "Tender Publication Date (aggregate by semester)", y = "Market Share of Top 3 Firms (%)", title = "Market Concentration",
             subtitle =  "The Market Share of Top 3 Suppliers in Each Semester from Jan 2015 to Dec 2022",
             caption = "Note: data retrieved from ONCAE in Mar 2022.The graph excludes the contracts that have top 1% total value as those contracts appears to be mistake.")+
...
```{r 6.2 total number of tenders per month, echo=FALSE}
...
## The number of contracts signed in relation to the contract signatue 

```{r 6.3 number of contracts, echo=FALSE}
...
```{r 6.4 average monetary value, echo=FALSE}
...
### 7.1  Do firms during covid supply a broader range of different products?
```{r 7.1 product classification, echo=FALSE}
      ...
      ggplot(firm_item_sum_stats, aes(x = semester, y = num_unspsc_sum))+
        ...
        labs(x = "Contract Signature Date (aggregate by semester)", y = "Number of Unique UNSPSC Commodity Code", title = "Product Classification",
             subtitle = "Number of different products supplied by firm from Jan 2015 to Dec 2022",
             caption ="Note: data retrieved from ONCAE in Mar 2023.")+
...
### the share of firms that have increased the product code during COVID 

```{r 7.2 product classification, echo=FALSE}
      ...
      firm_uspsc_panel <- firm_item_year%>%
        ...
        clean_names()%>%
        replace(is.na(.), 0)%>%  ##code change, there is not 2015 in this data, only 2016
...
### firms that sold COVID products in 2019, do they sell COVID products in 2020? 

```{r 7.3 product classification, echo=FALSE}
...
```{r 8.1 geographical analysis, echo=FALSE, warning=FALSE}
...
```{r 8.2 geographical analysis, echo=FALSE, warning=FALSE}
...
# ```
# 
# ```{r 8.3 geographical analysis, echo=FALSE, warning=FALSE}
# 
# 
...
## Product Classification  
### For firms that have sold or not sold any product in 2019, the average number of new products sold since 2020

```{r Product Classification DiD1, echo=FALSE}
...
### For firms that have sold or not sold any product in 2019, the average number of new COVID products sold since 2020

```{r product classification did2, echo=FALSE}
...
### For firms that have sold or not sold any product in 2019, the average number of new Non-COVID products sold since 2020

```{r product classification3, echo=FALSE}
...
```{r procurement method table, echo=FALSE}
...
```{r procurement method visual, echo=FALSE}
