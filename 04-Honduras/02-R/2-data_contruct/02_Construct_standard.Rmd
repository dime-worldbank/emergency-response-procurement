...
```{r 4.2 construct new winners, echo=FALSE}
      ...
      # add Group dummy (merge covid firm ID to firm level data)
        ...
        # visualization   
          ...
          ggsave(paste0(output, "/New_winner_per_month.jpeg"),
                 width = 10,
                 height = 8,
                 units = c("in"),
                 dpi = 300)
...
```{r 6.3 number of contracts, echo=FALSE}
      ...
      # the number of contracts signed in relation to the contract signature date 
...
```{r 6.4 average monetary value, echo=FALSE}
      ...
      # the value of contracts in relation to contract signature date (also use the contract value data)
...
# DiD ------------------------------------------------------------------------------------------------------------
      ...
      firm_item_string <- firm_item_2019%>%
        ...
        tidyr::unite("unspsc_2019", a1:a100, na.rm = TRUE, remove = FALSE)%>%
